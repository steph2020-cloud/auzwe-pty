...
class _SkillsSectionState extends State<SkillsSection>
                ...
                child: Column(
                  children: [
                    ContentArea(
                      ...
                      child: _buildAuzweptySm(width: contentAreaWidthSm),
                    ),
                    SpaceH40(),
                    ContentArea(
                      width: contentAreaWidthSm,
                ...
                child: Row(
                  children: [
                    ContentArea(
                      ...
                      child: _buildAuzweptyLg(width: contentAreaWidthLg),
                    ),
                    ContentArea(
                      width: contentAreaWidthLg,
  ...
  Widget _buildAuzweptyLg({required double width}) {
    return Container(
      child: Row(
        children: [
          Expanded(
  ...
  Widget _buildAuzweptySm({required double width}) {
