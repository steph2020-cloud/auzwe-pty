...
class _ProjectsSectionState extends State<ProjectsSection>
                      ...
                      child: Row(
                        ...
                        children: [
                          ContentArea(
                            ...
                            child: _buildauzweptyInfoSectionLg(),
                          ),
                          Spacer(),
                          AuzweptyButton(
                            buttonTitle: StringConst.ALL_PROJECTS,
  ...
  Widget _buildauzweptyInfoSectionSm() {
...
//      child: ,
  ...
  Widget _buildauzweptyInfoSectionLg() {
    return AuzweptyInfoSection1(
      sectionTitle: StringConst.MY_WORKS,
      title1: StringConst.MEET_MY_PROJECTS,
      hasTitle2: false,
      body: StringConst.PROJECTS_DESC,
