...
import 'package:auzwepty/presentation/widgets/bullet_text.dart';
                  ...
                  ResponsiveBuilder(
                    builder: (context, sizingInformation) {
                      ...
                      if (screenWidth < (RefinedBreakpoints().tabletSmall)) {
                        return _buildAuzweptyInfoSectionSm();
                      } else {
                        return _buildAuzweptyInfoSectionLg();
                      }
                    },
                  ),
                  SpaceH50(),
