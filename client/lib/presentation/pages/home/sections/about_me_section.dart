...
import 'package:auzwepty/presentation/widgets/buttons/social_button_2.dart';
import 'package:auzwepty/presentation/widgets/content_area.dart';
import 'package:auzwepty/presentation/widgets/empty.dart';
import 'package:auzwepty/presentation/widgets/auzwepty_info_section.dart';
import 'package:auzwepty/presentation/widgets/auzwepty_link.dart';
...
class _AboutMeSectionState extends State<AboutMeSection>
  ...
  Widget _buildImage({required double width, required double height}) {
    ...
    double fontSize = responsiveSize(context, 30, 25, md: 35);
        ...
        Positioned(
          ...
          child: FadeTransition(
            ...
            child: Column(
              ...
              children: [
                Text(
                  StringConst.HI  + " " + StringConst.THERE,
                  style: titleStyle,
                ),
             //   Text(StringConst.THERE, style: titleStyle,),
              ],
            ),
          ),
        ),
  ...
  Widget auzweptyInfoSectionSm({required double width}) {
    TextTheme textTheme = Theme.of(context).textTheme;
    return AuzweptyInfoSection2(
      sectionTitle: StringConst.ABOUT_ME,
      title1: StringConst.CREATIVE_DESIGN,
      title2: StringConst.HELP,
      body: StringConst.ABOUT_ME_DESC,
