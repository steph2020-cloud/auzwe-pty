...
class AuzweptyCard extends StatefulWidget {
  AuzweptyCard({
    this.leading,
    this.title,
    this.subtitle,
  ...
  @override
  _AuzweptyCardState createState() => _AuzweptyCardState();
}

class _AuzweptyCardState extends State<AuzweptyCard>
