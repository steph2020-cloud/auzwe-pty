...
class AnimatedAuzweptyButton extends StatefulWidget {
  final String title;
  ...
  @override
  _AnimatedAuzweptyButtonState createState() => _AnimatedAuzweptyButtonState();
}

class _AnimatedAuzweptyButtonState extends State<AnimatedAuzweptyButton> {
