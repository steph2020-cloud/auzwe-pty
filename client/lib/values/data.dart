...
class Data {
  ...
  static List<ProjectCategoryData> projectCategories = [
    ...
    ProjectCategoryData(title: StringConst.MOBILE_APP, number: 4),
  ];
  ...
  static List<AuzweptyCardData> auzweptyCardData = [
    AuzweptyCardData(
    ...
    */
    AuzweptyCardData(
      title: StringConst.MOBILEAPP,
      subtitle: StringConst.MOBILEAPP_DESC,
      leadingIcon: Icons.done,
      trailingIcon: Icons.chevron_right,
    ...
    AuzweptyCardData(
      ...
      subtitle: StringConst.WEB_DESIGN_DESC,
      leadingIcon: Icons.done,
      trailingIcon: Icons.chevron_right,
      leadingIconColor: AppColors.black,
      circleBgColor: AppColors.grey50,
